...
It consists of two pages: the :guilabel:`Laminography` tab offers settings for tube and detector position and output options. 
The :guilabel:`Advanced` tab offers settings that are mainly directed towards experts.
