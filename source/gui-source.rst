...
The :guilabel:`Source` panel is used for defining the radiation source settings (:numref:`guiSourceDefault`).
...
.. figure:: pictures/gui-parameterP-SourceDefault.png
    :alt: The parameter panel Source.
    :width: 41.3%

    The parameter panel Source.
