...
.. note::
    ...
    If you choose **cylinder** and **cone**, you can turn **volume correction** on and off in **Options**. If you select an **ellipsoid**, you can also decide whether to use a **regular ellipsoid grid**.
